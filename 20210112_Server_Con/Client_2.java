...
public class Client_2{
    public static void main(String[] args){
        ...
        try{
            ...
            System.out.println("Client_2: OK: socket:"+clientSocket.getLocalPort());
            ...
            System.out.println("Client_2: connecting...");
            clientSocket.connect(internetSocketAddress);
            System.out.println("Client_2: OK: connected to -> "+internetSocketAddress.toString());
